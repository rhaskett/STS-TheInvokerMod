...
@AutoAdd.Ignore
public class FalconBladeRecipe extends AbstractRecipeCard {
    public static final String ID = makeID(FalconBladeRecipe.class.getSimpleName());
    ...
    private static final int COST = SagesMask.COST * 2;

    public FalconBladeRecipe() {
