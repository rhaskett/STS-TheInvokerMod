...
public class StaticPowerInfo {
    ...
    private <T extends AbstractPower> StaticPowerInfo(Class<T> powerClass) {
        CLASS = powerClass;
        ID = InvokerMod.makeID(powerClass.getSimpleName());
        ...
        TEXTURE_84 = TextureLoader.getTexture(InvokerMod.makePowerPath(imageFilenamePrefix + "_84.png"));
        TEXTURE_32 = TextureLoader.getTexture(InvokerMod.makePowerPath(imageFilenamePrefix + "_32.png"));
